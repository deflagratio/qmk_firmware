 ...
 * `--------------------------------------------/       /     \      \-----------------------------------------'
 *           |SCREENCAP/ | DELETE| SPACE/    | /NAV/ /       \NUM \  |SPACE  | BACKSPACE |NUMLOCK/|
 ...
 */
 ...
 [_WORKMAN] = LAYOUT(
  ...
  SFT_T(KC_CAPS), KC_Z, KC_X,  KC_M,  KC_C,    KC_V, LALT(KC_TAB),     C(KC_TAB), KC_K,     KC_L,    KC_COMM, KC_DOT,  KC_SLSH, KC_BTN1,
       TD(TD_SCREEN_CAP), KC_DEL, SFT_T(KC_SPC), LT(NAV,KC_ENT),        LT(NUM,KC_ENT),  SFT_T(KC_SPC),  KC_BSPC, LGUI_T(KC_NLCK)
),
/* QWERTY
* ,-----------------------------------------------.                    ,---------------------------------------------.
 * | ESC/LAYOUT|   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |TOGGLE NAV|
...
* `----------------------------------------------/       /     \      \----------------------------------------------'
*             |SCREENCAP/ | DELETE| SPACE/    | /NAV/ /       \NUM \ |SPACE  | BACKSPACE |NUMLOCK/|
*            |PRINTSCREEN|        |          |/ ENTER /         \ENTER \| SHIFT |           | WIN    |
*           `--------------------------------''-------'          '------''----------------------------'
*/
[_QWERTY] = LAYOUT(
   TD(TD_QWERTY),  KC_1, KC_2,  KC_3,  KC_4,    KC_5,                          KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    TG(NAV),
   ...
   SFT_T(KC_CAPS), KC_Z, KC_X,  KC_C,  KC_V,    KC_B, LALT(KC_TAB), C(KC_TAB), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_BTN1,
     TD(TD_SCREEN_CAP), KC_DEL, KC_SPC, LT(NAV,KC_ENT),        LT(NUM,KC_ENT),  SFT_T(KC_SPC),  KC_BSPC, LGUI_T(KC_NLCK)
 ),
/* NAV
 * ,-----------------------------------------------.                    ,----------------------------------------------------------.
 * |CTRL,ALT,DEL|      |      |      |      |      |                    |          |         |          |          |      |        |
